 ...
 * @author Cactus
 */
public class InfoProy {
    
    private int idInfoProy;
    private String r1;
    private String r2;
    private String r3;
    private String r4;
    ...
    public InfoProy(int idInfoProy, String r1, String r2, String r3, String r4, String r5, String r6, String r7, String r8, String r9, String r10, String r11, int idPreguntaF, int idPersonaF, String respuestas) {
        this.setR1(r1);
        this.setR2(r2);
        this.setR3(r3);
        this.setR4(r4);
        ...
        this.setR10(r10);
        this.setR11(r11);
        this.setIdInfoProy(idInfoProy);
        this.setIdPreguntaF(idPreguntaF);
        this.setIdPersonaF(idPersonaF);
        this.setRespuestas(respuestas);
    }

    public int getIdInfoProy() {
        return idInfoProy;
    }

    public void setIdInfoProy(int idInfoProy) {
        this.idInfoProy = idInfoProy;
    }
